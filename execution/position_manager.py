...
class PositionManager:
    ...
    # =========================
    # OPEN POSITION (FIX CRÍTICO DE COMPATIBILIDAD)
    # =========================
    def open_position(self, side, entry, sl, tp, risk, score):

        # (risk se acepta pero NO se usa aquí → evita crashes futuros)
