...
class MarketDataEngine:
    ...
    def __init__(self):
        ...
        logger.info(
            f"MarketDataEngine iniciado | Token: {'OK' if self._token else 'MISSING'}"
        )
    ...
    async def get_multi_tf(self, symbol: str) -> MultiTF:
        ...
        tasks = {
            tf: self.fetch_bars(symbol, tf, BARS[tf])
