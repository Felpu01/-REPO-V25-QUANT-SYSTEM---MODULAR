...
for i in range(20, len(prices)):
    ...
    # 🔥 FIX: NORMALIZACIÓN TOTAL DE TREND
    ...
    # 🔥 BOOST REAL INSTITUCIONAL (CORRIGE SCORE PEGADO EN 0.30)
    structure_score = 0.0
    ...
    if sweep_up or sweep_down:
        structure_score += 0.20
    if displacement_valid:
        structure_score += displacement_strength * 0.35
