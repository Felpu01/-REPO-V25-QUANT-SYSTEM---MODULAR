...
print("🚀 V35 QUANT SYSTEM STARTED (V35.6 STABLE)")
...
for i in range(20, len(prices)):
    ...
    # 🔥 estabilidad extra (evita ruido extremo)
    bias_memory *= 0.98
    ...
    # =====================
    # SIGNAL CONTROL (FIX REAL)
    # =====================
    force_trade = (
        sc >= 0.85 and bias != "NEUTRAL" and vol > 0.45
    )
