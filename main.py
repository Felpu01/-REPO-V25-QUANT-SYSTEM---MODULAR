...
# 🔥 NEW: entry quality module
from entry_quality import entry_quality
...
for i in range(20, len(prices)):
    ...
    # =========================
    # BIAS MEMORY (stable institutional smoothing)
    # =========================
    bias_memory *= 0.93
    ...
    # ==========================================================
    # FIX 1 — SCORE GRADIENTE REAL (STRUCTURE + FLOW)
    # ==========================================================
    ...
    # gradient merge (institutional smoothing)
    sc = (base_score * 0.6) + (structure_score * 0.4)

    sc = max(0.0, min(sc, 1.0))


    # ==========================================================
    # FIX 2 — ENTRY QUALITY FILTER (REAL MODULE)
    # ==========================================================
    eq = entry_quality(
    ...
    # ==========================================================
    # FIX 3 — SIGNAL GATE (INSTITUTIONAL EXECUTION FILTER)
    # ==========================================================
    min_score = 0.85 if regime == "EXPANSION" else 0.90
