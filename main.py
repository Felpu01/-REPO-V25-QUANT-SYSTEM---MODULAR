...
for i in range(10, len(prices)):
    ...
    # =========================
    # 🚨 ADAPTIVE BIAS MEMORY FIX (CRÍTICO)
    # =========================
    if regime == "RANGE":
        bias_memory *= 0.75   # RESET RÁPIDO (anti-chop)

    elif regime == "TREND":
        bias_memory *= 0.88   # normal decay

    elif regime == "EXPANSION":
        bias_memory *= 0.95   # mantiene convicción
    ...
    # =========================
    # CONTEXT FILTER (INSTITUTIONAL QUALITY CONTROL)
    # =========================
    valid_context = False
