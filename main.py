...
print("🚀 V40 QUANT SYSTEM STARTED (INSTITUTIONAL STABILITY CORE)")
...
if runtime:
    ...
    # 🔥 V40 FIX: smooth warm start (avoid bias explosion)
    bias_memory *= 0.85
...
for i in range(20, len(prices)):
    ...
    # 🔥 FIX: stable trend normalization
    ...
    # 🔥 FIX: prevent spikes
    sc = max(0.0, min(raw_score, 1.0))


    # =========================
    # ENTRY QUALITY (V40 STRONGER FILTER)
    # =========================
    eq = entry_quality(
    ...
    # =========================
    # SIGNAL GATE (V40 CORE FIX)
    # =========================
    min_score = 0.88 if regime == "EXPANSION" else 0.92
    ...
    # 🔥 V40 FIX: cooldown must NOT block high quality setups
