...
print("🚀 V35 QUANT SYSTEM STARTED (STABLE ARCHITECTURE)")
...
for i in range(20, len(prices)):
    ...
    # =====================
    # BIAS MEMORY (V35.4 FIX)
    # =====================
    bias_memory *= 0.96  # 🔥 menos ruido, más estabilidad
    ...
    # =====================
    # OVERTRADING PROTECTION (🔥 NUEVO)
    # =====================
    if total_trades > 0:
        trade_rate = total_trades / (i + 1)
        if trade_rate > 0.08:
            signal = "WAIT"
