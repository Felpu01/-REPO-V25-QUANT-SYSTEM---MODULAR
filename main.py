...
print("🚀 V40.3 QUANT SYSTEM STARTED (STABILITY FIXED CORE)")
...
if runtime:
    ...
    bias_memory *= 0.80  # 🔥 stronger decay (FIX 2)
...
for i in range(20, len(prices)):
    ...
    # =========================
    # BIAS MEMORY (FIX 2 — adaptive reset)
    # =========================
    bias_memory *= 0.90
    ...
    # =========================
    # SIGNAL GATE (FIX 5 — stricter + stable)
    # =========================
    min_score = (
