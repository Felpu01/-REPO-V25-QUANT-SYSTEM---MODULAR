...
while True:
    ...
    # 🧠 SIGNAL LOGIC IMPROVED (menos rígido, más real)
    signal = "WAIT"

    institutional_zone = (
        score >= 0.75 or sweep or regime == "LIQUIDITY_EVENT"
    )

    bullish_setup = bos_up and (choch_up or trend == "TREND_UP")
    bearish_setup = bos_down and (choch_down or trend == "TREND_DOWN")
